...
export class HttpWithSnackbarService {
	...
	public delete<T>(url: string, message: string): Observable<T> {
		return this.http.delete<T>(url).pipe(this.getSnackBarPipe<T>(message));
	}
